...
public class Medicine3Activity extends AppCompatActivity {

    public final String JSON_URL = "https://api.myjson.com/bins/1g07ik" ;
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Medicine3Activity.this);
