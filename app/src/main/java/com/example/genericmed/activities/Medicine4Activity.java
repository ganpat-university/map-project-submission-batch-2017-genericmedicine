...
public class Medicine4Activity extends AppCompatActivity {

    public final String JSON_URL = "https://api.myjson.com/bins/gvmto" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicine4);
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Medicine4Activity.this);
