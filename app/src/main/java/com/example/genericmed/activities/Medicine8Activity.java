...
public class Medicine8Activity extends AppCompatActivity {

    public final String JSON_URL = "https://api.myjson.com/bins/fqwrw" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicine8);
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Medicine8Activity.this);
