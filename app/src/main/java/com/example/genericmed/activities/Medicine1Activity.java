...
public class Medicine1Activity extends AppCompatActivity {

    public final String JSON_URL = "https://api.myjson.com/bins/10rav8" ;
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Medicine1Activity.this);
