...
public class Medicine2Activity extends AppCompatActivity {

    public final String JSON_URL = "https://api.myjson.com/bins/1fzs8k" ;
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Medicine2Activity.this);
