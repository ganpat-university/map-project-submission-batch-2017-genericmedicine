...
public class Medicine6Activity extends AppCompatActivity {

    public final String JSON_URL = "https://api.myjson.com/bins/18bpt8" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicine6);
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Medicine6Activity.this);
