...
public class Medicine7Activity extends AppCompatActivity {

    public final String JSON_URL = "https://api.myjson.com/bins/1evhgs" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicine7);
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Medicine7Activity.this);
